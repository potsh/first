...
namespace RimWorld
{
	public class JobDriver_GoForWalk : JobDriver
	{
		...
		protected override IEnumerable<Toil> MakeNewToils()
		{
			...
			this.FailOn(() => !JoyUtility.EnjoyableOutsideNow(_003CMakeNewToils_003Ec__Iterator._0024this.pawn));
			...
			goToil.tickAction = delegate
			{
				...
				{
					JoyUtility.JoyTickCheckEnd(_003CMakeNewToils_003Ec__Iterator._0024this.pawn);
				}
			};
			yield return goToil;
