...
namespace RimWorld
{
	public class SitePartWorker_Turrets : SitePartWorker
	{
		...
		{
			return string.Format(base.GetPostProcessedDescriptionDialogue(site, siteCoreOrPart), GetThreatsInfo(siteCoreOrPart.parms));
		}

		public override string GetPostProcessedThreatLabel(Site site, SiteCoreOrPartBase siteCoreOrPart)
		{
			return base.GetPostProcessedThreatLabel(site, siteCoreOrPart) + " (" + GetThreatsInfo(siteCoreOrPart.parms) + ")";
		}
