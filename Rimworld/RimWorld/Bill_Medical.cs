	...
	public class Bill_Medical : Bill
	{
		...
		public BodyPartRecord Part
		{
			...
			set
			{
				...
				else if (UnityData.isDebugBuild && part != null && !GiverPawn.RaceProps.body.AllParts.Contains(part))
				{
					Log.Error("Cannot set BodyPartRecord which doesn't belong to the pawn " + GiverPawn.ToStringSafe());
				}
				else
				{
					part = value;
		...
		public override Bill Clone()
		{
			...
			bill_Medical.consumedInitialMedicineDef = consumedInitialMedicineDef;
			return bill_Medical;
		}
	}
}
