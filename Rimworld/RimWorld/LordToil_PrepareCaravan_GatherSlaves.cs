...
namespace RimWorld
{
	public class LordToil_PrepareCaravan_GatherSlaves : LordToil
	{
		...
		public override void LordToilTick()
		{
			...
			{
				GatherAnimalsAndSlavesForCaravanUtility.CheckArrived(lord, lord.ownedPawns, meetingPoint, "AllSlavesGathered", (Pawn x) => !x.IsColonist && !x.RaceProps.Animal, GatherAnimalsAndSlavesForCaravanUtility.IsFollowingAnyone);
			}
		}
	}
}
