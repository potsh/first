...
namespace RimWorld
{
	public class LordToil_PrepareCaravan_GatherAnimals : LordToil
	{
		...
		public override void LordToilTick()
		{
			...
			{
				GatherAnimalsAndSlavesForCaravanUtility.CheckArrived(lord, lord.ownedPawns, meetingPoint, "AllAnimalsGathered", (Pawn x) => x.RaceProps.Animal, GatherAnimalsAndSlavesForCaravanUtility.IsFollowingAnyone);
			}
		}
	}
}
