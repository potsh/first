	...
	public class Need_Rest : Need
	{
		...
		public override void NeedInterval()
		{
			...
			if (ticksAtZero > 1000 && pawn.Spawned)
			{
				...
				{
					pawn.jobs.StartJob(new Job(JobDefOf.LayDown, pawn.Position), JobCondition.InterruptForced, null, resumeCurJobAfterwards: false, cancelBusyStances: true, null, JobTag.SatisfyingNeeds);
