...
namespace RimWorld
{
	public class ThinkNode_ConditionalCloseToDutyTarget : ThinkNode_Conditional
	{
		...
		public override ThinkNode DeepCopy(bool resolve = true)
		{
			...
			thinkNode_ConditionalCloseToDutyTarget.maxDistToDutyTarget = maxDistToDutyTarget;
			return thinkNode_ConditionalCloseToDutyTarget;
		}

		protected override bool Satisfied(Pawn pawn)
		{
			return pawn.mindState.duty.focus.IsValid && pawn.Position.InHorDistOf(pawn.mindState.duty.focus.Cell, maxDistToDutyTarget);
		}
	}
}
