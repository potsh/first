...
namespace RimWorld
{
	public class JobGiver_AISapper : ThinkNode_JobGiver
	{
		...
		public override ThinkNode DeepCopy(bool resolve = true)
		{
			...
			jobGiver_AISapper.canMineMineables = canMineMineables;
			jobGiver_AISapper.canMineNonMineables = canMineNonMineables;
		...
		protected override Job TryGiveJob(Pawn pawn)
		{
			...
			return new Job(JobDefOf.Goto, intVec, 500, checkOverrideOnExpiry: true);
		}
	}
}
