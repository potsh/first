	...
	public abstract class MainTabWindow_PawnTable : MainTabWindow
	{
		...
		public override Vector2 RequestedTabSize
		{
			get
			{
				...
				float x = size.x + Margin * 2f;
				Vector2 size2 = table.Size;
				return new Vector2(x, size2.y + ExtraBottomSpace + ExtraTopSpace + Margin * 2f);
			}
		}
		...
		{
			return (PawnTable)Activator.CreateInstance(PawnTableDef.workerClass, PawnTableDef, new Func<IEnumerable<Pawn>>(this.get_Pawns), UI.screenWidth - (int)(Margin * 2f), (int)((float)(UI.screenHeight - 35) - ExtraBottomSpace - ExtraTopSpace - Margin * 2f));
		}
