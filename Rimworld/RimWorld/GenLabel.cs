...
namespace RimWorld
{
	public static class GenLabel
	{
		...
		private struct LabelRequest : IEquatable<LabelRequest>
		{
			...
			{
				return entDef == other.entDef && stuffDef == other.stuffDef && stackCount == other.stackCount && quality == other.quality && health == other.health && maxHealth == other.maxHealth && wornByCorpse == other.wornByCorpse;
			}
