...
namespace RimWorld
{
	public class TransferableImmutable : Transferable
	{
		...
		public override Thing AnyThing => (!HasAnyThing) ? null : things[0];

		public override ThingDef ThingDef => (!HasAnyThing) ? null : AnyThing.def;
		...
		public override string TipDescription => (!HasAnyThing) ? string.Empty : AnyThing.DescriptionDetailed;
		...
		public string LabelCapWithTotalStackCount => LabelWithTotalStackCount.CapitalizeFirst();
