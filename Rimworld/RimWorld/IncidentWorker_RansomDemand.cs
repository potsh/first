...
namespace RimWorld
{
	public class IncidentWorker_RansomDemand : IncidentWorker
	{
		...
		protected override bool TryExecuteWorker(IncidentParms parms)
		{
			...
			ChoiceLetter_RansomDemand choiceLetter_RansomDemand = (ChoiceLetter_RansomDemand)LetterMaker.MakeLetter(def.letterLabel, "RansomDemand".Translate(pawn.LabelShort, faction.Name, num, pawn.Named("PAWN")).AdjustedFor(pawn), def.letterDef);
