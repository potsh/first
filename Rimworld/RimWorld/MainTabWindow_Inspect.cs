...
namespace RimWorld
{
	...
	public class MainTabWindow_Inspect : MainTabWindow, IInspectPane
	{
		...
		private IEnumerable<object> Selected => Find.Selector.SelectedObjects;
		...
		public bool ShouldShowSelectNextInCellButton => NumSelected == 1 && (Find.Selector.SelectedZone == null || Find.Selector.SelectedZone.ContainsCell(lastSelectCell));
