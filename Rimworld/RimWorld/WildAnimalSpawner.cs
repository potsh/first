...
namespace RimWorld
{
	public class WildAnimalSpawner
	{
		...
		{
			if (Find.TickManager.TicksGame % 1213 == 0 && !AnimalEcosystemFull && Rand.Chance(0.0269555561f * DesiredAnimalDensity) && RCellFinder.TryFindRandomPawnEntryCell(out IntVec3 result, map, CellFinder.EdgeRoadChance_Animal, allowFogged: true))
			{
