	...
	public abstract class JobDriver_InteractAnimal : JobDriver
	{
		...
		private IEnumerable<Toil> FeedToils()
		{
			yield return new Toil
			{
				initAction = delegate
				{
					((_003CFeedToils_003Ec__Iterator1)/*Error near IL_004a: stateMachine*/)._0024this.feedNutritionLeft = RequiredNutritionPerFeed(((_003CFeedToils_003Ec__Iterator1)/*Error near IL_004a: stateMachine*/)._0024this.Animal);
				},
