...
namespace RimWorld
{
	public class Scenario : IExposable, WorkshopUploadable
	{
		...
		public IEnumerable<ScenPart> AllParts
		{
			get
			{
				yield return (ScenPart)playerFaction;
		...
		public void ExposeData()
		{
			...
			if (Scribe.mode == LoadSaveMode.PostLoadInit && parts.RemoveAll((ScenPart x) => x == null) != 0)
			{
		...
		public Scenario CopyForEditing()
		{
			...
			scenario.parts.AddRange(from p in parts
		...
		{
			return name.NullOrEmpty() ? "LabellessScenario" : name;
		}
