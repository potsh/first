...
namespace RimWorld
{
	...
	public static class SelectionDrawerUtility
	{
		...
		public static void CalculateSelectionBracketPositionsUI<T>(Vector2[] bracketLocs, T obj, Rect rect, Dictionary<T, float> selectTimes, Vector2 textureSize, float jumpDistanceFactor = 1f)
		{
			...
			ref Vector2 reference = ref bracketLocs[0];
			Vector2 center = rect.center;
			float x = center.x - num3;
			Vector2 center2 = rect.center;
			reference = new Vector2(x, center2.y - num4);
			ref Vector2 reference2 = ref bracketLocs[1];
			Vector2 center3 = rect.center;
			float x2 = center3.x + num3;
			Vector2 center4 = rect.center;
			reference2 = new Vector2(x2, center4.y - num4);
			ref Vector2 reference3 = ref bracketLocs[2];
			Vector2 center5 = rect.center;
			float x3 = center5.x + num3;
			Vector2 center6 = rect.center;
			reference3 = new Vector2(x3, center6.y + num4);
			ref Vector2 reference4 = ref bracketLocs[3];
			Vector2 center7 = rect.center;
			float x4 = center7.x - num3;
			Vector2 center8 = rect.center;
			reference4 = new Vector2(x4, center8.y + num4);
		}
