	...
	public class CaravanArrivalAction_Enter : CaravanArrivalAction
	{
		...
		public override void Arrived(Caravan caravan)
		{
			...
			if (map != null)
			{
				...
				{
					Find.LetterStack.ReceiveLetter("LetterLabelCaravanEnteredMap".Translate(mapParent), "LetterCaravanEnteredMap".Translate(caravan.Label, mapParent).CapitalizeFirst(), LetterDefOf.NeutralEvent, t);
				}
			}
		}
