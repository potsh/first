...
namespace RimWorld.Planet
{
	public static class CaravanPawnsNeedsUtility
	{
		...
		{
			return food.IsNutritionGivingIngestible && pawn.WillEat(food) && (int)food.ingestible.preferability > 1 && (!food.IsDrug || !pawn.IsTeetotaler());
		}
		...
		public static float GetFoodScore(Thing food, Pawn pawn)
		{
			...
			{
				int a = food.TryGetComp<CompRottable>()?.TicksUntilRotAtCurrentTemp ?? 2147483647;
