...
namespace RimWorld.Planet
{
	public struct GlobalTargetInfo : IEquatable<GlobalTargetInfo>
	{
		...
		public bool IsValid => thingInt != null || cellInt.IsValid || worldObjectInt != null || tileInt >= 0;

		public bool IsMapTarget => HasThing || cellInt.IsValid;

		public bool IsWorldTarget => HasWorldObject || tileInt >= 0;
		...
		public override string ToString()
		{
			...
			if (cellInt.IsValid)
			{
				return cellInt.ToString() + ", " + ((mapInt == null) ? "null" : mapInt.GetUniqueLoadID());
			}
			if (worldObjectInt != null)
			{
