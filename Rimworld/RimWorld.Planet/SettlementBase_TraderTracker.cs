...
namespace RimWorld.Planet
{
	public abstract class SettlementBase_TraderTracker : IThingHolder, IExposable
	{
		...
		public virtual bool CanTradeNow => TraderKind != null && (stock == null || stock.InnerListForReading.Any((Thing x) => TraderKind.WillTrade(x.def)));
		...
		protected virtual void RegenerateStock()
		{
			...
			if (settlement.Faction == null || !settlement.Faction.IsPlayer)
			{
				...
				parms.traderFaction = settlement.Faction;
