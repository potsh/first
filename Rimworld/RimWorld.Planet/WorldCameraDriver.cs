		...
		public void OnGUI()
		{
			...
			if (!LongEventHandler.ShouldWaitForEvent)
			{
				...
				if (!AnythingPreventsCameraMotion)
				{
					...
					{
						mouseDragVect *= CameraDriver.HitchReduceFactor;
						mouseDragVect.x *= -1f;
						desiredRotation += mouseDragVect * config.dollyRateMouseDrag;
			...
			if (!LongEventHandler.ShouldWaitForEvent)
			{
				...
				else
				{
					...
					for (int i = 0; i < num2; i++)
					{
						...
						{
							float num4 = desiredAltitude - altitude;
