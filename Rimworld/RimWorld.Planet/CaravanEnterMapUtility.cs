...
namespace RimWorld.Planet
{
	public static class CaravanEnterMapUtility
	{
		...
		{
			return CellFinder.TryFindRandomReachableCellNear(root, map, (float)radius, TraverseParms.For(TraverseMode.NoPassClosedDoors), (IntVec3 c) => c.Standable(map) && c.GetFirstPawn(map) == null, null, out result);
		}
	}
}
