...
namespace RimWorld.Planet
{
	public class WorldInspectPane : Window, IInspectPane
	{
		...
		private bool SelectedSingleObjectOrTile => NumSelectedObjects == 1 || (NumSelectedObjects == 0 && SelectedTile >= 0);
		...
		private string TileInspectString
		{
			get
			{
				...
				{
					string str = (WorldPathGrid.CalculatedMovementDifficultyAt(SelectedTile, perceivedStatic: false) * Find.WorldGrid.GetRoadMovementDifficultyMultiplier(SelectedTile, -1)).ToString("0.#");
					stringBuilder.AppendLine();
