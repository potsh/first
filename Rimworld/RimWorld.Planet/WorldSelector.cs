...
namespace RimWorld.Planet
{
	public class WorldSelector
	{
		...
		public bool AnyObjectOrTileSelected => NumSelectedObjects != 0 || selectedTile >= 0;
		...
		public IEnumerable<WorldObject> SelectableObjectsUnderMouse()
		{
			...
			return SelectableObjectsUnderMouse(out clickedDirectlyOnCaravan, out clickedDirectlyOnCaravan);
		}
