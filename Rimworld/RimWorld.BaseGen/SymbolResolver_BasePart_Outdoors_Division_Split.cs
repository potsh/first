...
namespace RimWorld.BaseGen
{
	public class SymbolResolver_BasePart_Outdoors_Division_Split : SymbolResolver
	{
		...
		public override bool CanResolve(ResolveParams rp)
		{
			...
			if (!TryFindSplitPoint(horizontal: false, rp.rect, out int splitPoint, out int spaceBetween) && !TryFindSplitPoint(horizontal: true, rp.rect, out splitPoint, out spaceBetween))
			{
				return false;
			}
			return true;
