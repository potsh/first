	...
	public abstract class Sample
	{
		...
		protected virtual float Volume
		{
			get
			{
				...
				float num = resolvedVolume;
				SoundInfo info = Info;
				return num * info.volumeFactor * MappedVolumeMultiplier * ContextVolumeMultiplier;
			}
		}
		...
		public Sample(SubSoundDef def)
		{
			...
			foreach (SoundParamTarget_Volume item in (from m in subDef.paramMappings
