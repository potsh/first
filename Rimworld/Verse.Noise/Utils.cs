...
namespace Verse.Noise
{
	internal static class Utils
	{
		...
		internal static double GradientCoherentNoise3D(double x, double y, double z, long seed, QualityMode quality)
		{
			...
			a = GradientNoise3D(x, y, z, num, iy, num3, seed);
			b = GradientNoise3D(x, y, z, ix, iy, num3, seed);
			double b2 = InterpolateLinear(a, b, position);
			double a3 = InterpolateLinear(a2, b2, position2);
			a = GradientNoise3D(x, y, z, num, num2, iz, seed);
			b = GradientNoise3D(x, y, z, ix, num2, iz, seed);
			a2 = InterpolateLinear(a, b, position);
			a = GradientNoise3D(x, y, z, num, iy, iz, seed);
			b = GradientNoise3D(x, y, z, ix, iy, iz, seed);
			b2 = InterpolateLinear(a, b, position);
			double b3 = InterpolateLinear(a2, b2, position2);
			return InterpolateLinear(a3, b3, position3);
		}
