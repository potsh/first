...
namespace Verse.Noise
{
	public abstract class ModuleBase : IDisposable
	{
		...
		public int SourceModuleCount => (modules != null) ? modules.Length : 0;
		...
		{
			return (float)GetValue((double)coordinate.x, 0.0, (double)coordinate.z);
		}

		public float GetValue(IntVec3 coordinate)
		{
			return (float)GetValue((double)coordinate.x, (double)coordinate.y, (double)coordinate.z);
		}
