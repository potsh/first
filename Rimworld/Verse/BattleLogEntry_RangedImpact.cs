...
namespace Verse
{
	public class BattleLogEntry_RangedImpact : LogEntry_DamageResult
	{
		...
		{
			return t == initiatorPawn || t == recipientPawn || t == originalTargetPawn;
		}
		...
		public override IEnumerable<Thing> GetConcerns()
		{
			...
			{
				yield return (Thing)originalTargetPawn;
				/*Error: Unable to find new state assignment for yield return*/;
			}
		}
		...
		protected override GrammarRequest GenerateGrammarRequest()
		{
			...
			{
				result.Includes.Add((!deflected) ? RulePackDefOf.Combat_RangedDamage : RulePackDefOf.Combat_RangedDeflect);
			}
			else
			{
			...
			result.Constants["COVER_missing"] = ((coverDef == null) ? "True" : "False");
			if (coverDef != null)
			{
