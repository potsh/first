...
namespace Verse
{
	public class Dialog_MessageBox : Window
	{
		...
		public override void DoWindowContents(Rect inRect)
		{
			...
			string label = (!InteractionDelayExpired) ? (buttonAText + "(" + Mathf.Ceil(TimeUntilInteractive).ToString("F0") + ")") : buttonAText;
			...
			if (buttonCText != null && Widgets.ButtonText(new Rect(num3 + 10f, inRect.height - 35f, width2, 35f), buttonCText))
			{
