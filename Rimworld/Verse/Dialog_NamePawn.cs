	...
	public class Dialog_NamePawn : Window
	{
		...
		public override void DoWindowContents(Rect inRect)
		{
			...
			if (Widgets.ButtonText(new Rect(inRect.width / 2f + 20f, inRect.height - 35f, inRect.width / 2f - 20f, 35f), "OK") || flag)
			{
				...
				string text4 = (!pawn.def.race.Animal) ? "PawnGainsName".Translate(curName, pawn.story.Title, pawn.Named("PAWN")).AdjustedFor(pawn) : "AnimalGainsName".Translate(curName);
				Messages.Message(text4, pawn, MessageTypeDefOf.PositiveEvent, historical: false);
			}
		}
	}
}
