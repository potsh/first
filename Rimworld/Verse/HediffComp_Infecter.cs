...
namespace Verse
{
	public class HediffComp_Infecter : HediffComp
	{
		...
		public override void CompPostPostAdd(DamageInfo? dinfo)
		{
			...
			else if (parent.Part.def.IsSolid(parent.Part, base.Pawn.health.hediffSet.hediffs))
			{
				ticksUntilInfect = -2;
			}
			else if (base.Pawn.health.hediffSet.PartOrAnyAncestorHasDirectlyAddedParts(parent.Part))
			{
				ticksUntilInfect = -2;
			}
			else
