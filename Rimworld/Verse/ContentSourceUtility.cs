...
namespace Verse
{
	...
	public static class ContentSourceUtility
	{
		...
		private static readonly Texture2D ContentSourceIcon_LocalFolder = ContentFinder<Texture2D>.Get("UI/Icons/ContentSources/LocalFolder");
		...
		public static Texture2D GetIcon(this ContentSource s)
		{
			...
			case ContentSource.LocalFolder:
				return ContentSourceIcon_LocalFolder;
