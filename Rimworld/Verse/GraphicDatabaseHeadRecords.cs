	...
	public static class GraphicDatabaseHeadRecords
	{
		private class HeadGraphicRecord
		{
			...
			public HeadGraphicRecord(string graphicPath)
			{
				...
				try
				{
					crownType = (CrownType)ParseHelper.FromString(array[array.Length - 2], typeof(CrownType));
					gender = (Gender)ParseHelper.FromString(array[array.Length - 3], typeof(Gender));
				}
				catch (Exception ex)
				{
