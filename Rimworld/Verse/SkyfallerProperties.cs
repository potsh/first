...
namespace Verse
{
	public class SkyfallerProperties
	{
		...
		public bool MakesShrapnel => metalShrapnelCountRange.max > 0 || rubbleShrapnelCountRange.max > 0;

		public bool CausesExplosion => explosionDamage != null && explosionRadius > 0f;
	}
}
