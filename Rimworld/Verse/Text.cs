...
namespace Verse
{
	public static class Text
	{
		...
		static Text()
		{
			...
			textFieldStyles[0].font = font;
			textFieldStyles[1].font = font2;
			textFieldStyles[2].font = font3;
			...
			for (int k = 0; k < textAreaReadOnlyStyles.Length; k++)
			{
				...
				GUIStyle gUIStyle = textAreaReadOnlyStyles[k];
