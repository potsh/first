	...
	public class KeyBindingDef : Def
	{
		...
		public bool KeyDownEvent
		{
			get
			{
				if (Event.current.type == EventType.KeyDown && Event.current.keyCode != 0 && KeyPrefs.KeyPrefsData.keyPrefs.TryGetValue(this, out KeyBindingData value))
				{
					...
					return Event.current.keyCode == value.keyBindingA || Event.current.keyCode == value.keyBindingB;
				}
				return false;
			}
		}
		...
		public bool JustPressed
		{
			get
			{
				if (KeyPrefs.KeyPrefsData.keyPrefs.TryGetValue(this, out KeyBindingData value))
				{
					return Input.GetKeyDown(value.keyBindingA) || Input.GetKeyDown(value.keyBindingB);
				}
				return false;
			}
		}
		...
		public bool IsDown
		{
			get
			{
				if (KeyPrefs.KeyPrefsData.keyPrefs.TryGetValue(this, out KeyBindingData value))
				{
					return Input.GetKey(value.keyBindingA) || Input.GetKey(value.keyBindingB);
				}
				return false;
			}
		}
