...
namespace Verse
{
	...
	public class Dialog_PawnTableTest : Window
	{
		...
		public override void DoWindowContents(Rect inRect)
		{
			...
			{
				pawnTableMin = new PawnTable(pawnTableDef, (Func<IEnumerable<Pawn>>)this.get_Pawns, 0, 0);
			...
			{
				pawnTableOptimal = new PawnTable(pawnTableDef, (Func<IEnumerable<Pawn>>)this.get_Pawns, 0, 0);
			...
			{
				pawnTableMax = new PawnTable(pawnTableDef, (Func<IEnumerable<Pawn>>)this.get_Pawns, 0, 0);
