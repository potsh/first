...
namespace Verse
{
	public struct DamageInfo
	{
		...
		{
			return "(def=" + defInt + ", amount= " + amountInt + ", instigator=" + ((instigatorInt == null) ? categoryInt.ToString() : instigatorInt.ToString()) + ", angle=" + angleInt.ToString("F1") + ")";
		}
	}
}
