...
namespace Verse
{
	public class MoteLeaf : Mote
	{
		...
		protected override bool EndOfLife => base.AgeSecs >= spawnDelay + FallTime + def.mote.solidTime + def.mote.fadeOutTime;
		...
		public override float Alpha
		{
			get
			{
				...
				if (ageSecs <= FallTime + def.mote.solidTime)
				{
					return 1f;
				}
				ageSecs -= FallTime + def.mote.solidTime;
