...
namespace Verse
{
	public class NameTriple : Name
	{
		...
		public override bool IsValid => !First.NullOrEmpty() && !Last.NullOrEmpty();
		...
		public override bool Equals(object obj)
		{
			...
			return First == nameTriple.First && Last == nameTriple.Last && Nick == nameTriple.Nick;
		}

		public override int GetHashCode()
		{
			int seed = 0;
			seed = Gen.HashCombine(seed, First);
			seed = Gen.HashCombine(seed, Last);
			return Gen.HashCombine(seed, Nick);
		}
	}
}
