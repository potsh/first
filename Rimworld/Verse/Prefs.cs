...
namespace Verse
{
	public static class Prefs
	{
		...
		public static bool ResetModsConfigOnCrash
		{
			get
			{
				return data == null || data.resetModsConfigOnCrash;
			}
			set
			{
		...
		public static bool PauseOnError
		{
			get
			{
				return data != null && data.pauseOnError;
			}
			set
			{
		...
		public static bool PauseOnUrgentLetter
		{
			get
			{
				return data.pauseOnUrgentLetter;
			}
			set
			{
				data.pauseOnUrgentLetter = value;
			}
		}
		...
		{
			if ((from name in PreferredNames
			where !name.NullOrEmpty()
			select name).TryRandomElement(out string result))
			{
