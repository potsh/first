...
namespace Verse
{
	public class Verb_LaunchProjectile : Verb
	{
		...
		{
			base.WarmupComplete();
			Find.BattleLog.Add(new BattleLogEntry_RangedFire(caster, (!currentTarget.HasThing) ? null : currentTarget.Thing, (base.EquipmentSource == null) ? null : base.EquipmentSource.def, Projectile, ShotsPerBurst > 1));
		}
