...
namespace Verse
{
	public class ThingFilter : IExposable
	{
		...
		private static IEnumerable<ThingDef> AllStorableThingDefs => from def in DefDatabase<ThingDef>.AllDefs
		where def.EverStorable(willMinifyIfPossible: true)
		select def;
		...
		public void ResolveReferences()
		{
			...
			if (disallowCheaperThan != -3.40282347E+38f)
			{
		...
		public virtual void CopyAllowancesFrom(ThingFilter other)
		{
			...
			{
				SetAllow(allStorableThingDef, other.Allows(allStorableThingDef));
			}
