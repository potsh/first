...
namespace Verse
{
	public abstract class Verb : IExposable, ILoadReferenceable
	{
		...
		public ThingWithComps EquipmentSource => (EquipmentCompSource == null) ? null : EquipmentCompSource.parent;

		public HediffComp_VerbGiver HediffCompSource => DirectOwner as HediffComp_VerbGiver;

		public Hediff HediffSource => (HediffCompSource == null) ? null : HediffCompSource.parent;

		public Pawn_MeleeVerbs_TerrainSource TerrainSource => DirectOwner as Pawn_MeleeVerbs_TerrainSource;

		public TerrainDef TerrainDefSource => (TerrainSource == null) ? null : TerrainSource.def;

		public Pawn CasterPawn => caster as Pawn;

		public bool CasterIsPawn => caster is Pawn;
		...
		public bool IsMeleeAttack => verbProps.IsMeleeAttack;
